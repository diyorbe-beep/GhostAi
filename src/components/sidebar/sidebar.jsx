...
const Sidebar = ({ onNewChat, recentChats = [], savedQuestions = [], onClearData }) => {
  ...
  return (
    <div className='sidebar'>
      <div className="top">
        ...
        {extended && activeTab === 'recent' && (
          <div className="recent">
            <p className='recent-title'>Recent Chats</p>
            {recentChats.length > 0 ? (
              recentChats.map((chat, index) => (
                <div key={index} className="recent-entry" onClick={() => onNewChat && onNewChat(chat)}>
